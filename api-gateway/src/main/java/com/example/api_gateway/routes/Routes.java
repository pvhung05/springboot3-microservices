...
public class Routes {
    ...
    @Bean
    public RouterFunction<ServerResponse> productServerRoutes() {
    ...
    @Bean
    public RouterFunction<ServerResponse> productServerSwaggerRoutes() {
    ...
    @Bean
    public RouterFunction<ServerResponse> orderServerRoutes() {
    ...
    @Bean
    public RouterFunction<ServerResponse> orderServerSwaggerRoutes() {
    ...
    @Bean
    public RouterFunction<ServerResponse> inventoryServerRoutes() {
    ...
    @Bean
    public RouterFunction<ServerResponse> inventoryServerSwaggerRoutes() {
    ...
    public RouterFunction<ServerResponse> fallbackRoutes() {
        return route("fallbackRoute")
                .GET("/fallbackRoute", request -> ServerResponse.
                        status(HttpStatus.SERVICE_UNAVAILABLE).body("Service Unavailable"))
                        .build();
    }
}
